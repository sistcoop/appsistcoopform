...
window.auth.sistcoopformUrl = 'http://localhost:8080/sistcoopform/rest';
...
angular.module('mean').factory('KCUser', ['KeycloakRestangular', 'REALM', function (KeycloakRestangular, REALM) {
